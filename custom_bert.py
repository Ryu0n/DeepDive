...
class CustomBertEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        self.pos_tag_embeddings = nn.Embedding(config.pos_tag_size, config.hidden_size)
    ...
    def forward(self, input_ids, token_type_ids=None, pos_tag_ids=None, **kwargs):
...
class CustomBertModel(BertModel):
    ...
    def forward(
        ...
        pos_tag_ids: Optional[torch.Tensor] = None,  # Add new embeddings
