...
- You can run this code at `train/trainer.py`
...
```
python src/trainer.py --train=[bool] --eval=[bool] --model_path=[str] --tokenizer_name=[str]
```  
...
- Add another PLM Classes (e.g. ELECTRA) in `train/utils.py`
